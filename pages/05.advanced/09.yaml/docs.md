...
YAML stands for _"YAML Ain't Markup Language"_ and it is used extensively in Kunena for its configuration files, blueprints, and also in page settings. 
...
Basically, the data you enter in a YAML file is used in conjunction with a library to create the pages you see within Kunena.
...
Here is a simple sequence you might find in Kunena. It is a basic list with each item in the list placed in its own line with an opening dash.
