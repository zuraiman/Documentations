...
Kunena has a variety of flexible linking options that allow you to link images from one page to another, and even from remote sources. If you have ever linked files using HTML or worked with a file system using a command line, a lot of this should be very easy to pick up.
...
To get us started, here is a quick look at some of the common components of a Kunena markdown-based image tag.
...
Kunena has integrated support for slugs in the header of the page's primary markdown file. This slug supersedes the folder name for the page, and any media files contained within.
...
>>> The main benefit of this, is that you can maintain link integrity in other systems outside of Kunena, such as GitHub.
...
>>>>>> A powerful technique is to create a `user/images/` folder in your Kunena site and put your images here.  Then you can easily reference them with an absolute URL from any Kunena page: `/images/test_image_4.jpg` and still be able to perform [media actions](../media) on them.
...
```markdown
![Remote Image 1](http://getKunena.org/images/testimage.png)
```
...
One of the main benefits of using images associated with pages is that it enables you to take advantage of [Kunena's powerful media actions](../media). For example, here is a line you would use to load an image from `/pages/01.blog/test-post-3/test_image_3.jpg` from `/pages/01.blog/test-post-1/test_image_1.jpg`
