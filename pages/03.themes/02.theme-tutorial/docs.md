...
Often, the best way to learn a new thing is to use an example, and then try to build your own creation from it. We are going to use this same methodology for creating a new Kunena theme.

## Antimatter

Kunena comes with a clean and modern theme called **Antimatter** which uses a simple base set of CSS styling that we call **Nucleus**.
...
As outlined in the [Theme Basics](../theme-basics) chapter, there are some key elements to a Kunena theme, so we must create them for our new theme:

1. Follow the [Installation instruction](../../basics/installation) and ensure you have Kunena properly installed.

2. Create a folder called `bootstrap` within the `user/themes` folder of your Kunena site to provide the basis of our new theme.
...
<html lang="en">
    <head>
      ...
      <body>
        ...
        <div class="footer">
            <div class="container">
                <p class="text-muted">Bootstrap Theme for <a href="http://getKunena.org">Kunena</a></p>
            </div>
        </div>
    </body>
...
<nav class="navbar navbar-default navbar-inverse navbar-static-top" role="navigation">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">Kunena</a>
        </div>
...
Then, open your browser, and point it to your Kunena site.  You should see something like this:
